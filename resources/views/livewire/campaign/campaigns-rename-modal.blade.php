            ...
            <div class="p-rel">
                <form class="" wire:submit="save">
                    <div class="d-flex justify-content-between pl-6 pr-4 py-4">
                        <div class="mr-3">Rename campaign</div>
                        <div wire:click="closeRenameModal">
                    ...
                    <div class="px-6 px-xl-10 pt-6 pt-xl-8 pb-10">
                        <div>
                            <div class="mb-2">
                                ...
                                <input type="hidden" wire:model="editId" data-qa="campaign-name-input" class="form-control">
                                @error('title')
                    ...
                    <div class="bg-yellow-05 border-bottom-radius-base px-6 py-4">
                        <div class="d-flex justify-content-end m-minus-2 flex-wrap">
                            <div class="m-2">
                                <button wire:click="closeRenameModal" data-qa="create-campaign-modal-cancel-button" class="btn btn-default">Cancel</button>
                            </div>
                            <div class="m-2">
                                <button type="submit" class="btn btn-color-transition btn btn-primary" data-qa="success-button">Rename</button>
                            </div>
                        </div>
                    </div>
                </form>
