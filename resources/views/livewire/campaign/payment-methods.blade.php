                            ...
                            <div data-v-09345d12="" class="flex-grow-1 min-w-0">
                                <div data-v-09345d12="">
                                    ...
                                    <p data-qa="payment-method-title" class="mb-8">
                                          Provide supporters with familiar payment options, including cryptocurrency, to simplify the donation process and boost conversion rates.
                                    </p>
                                        
                                        <div class="max-w-px-550">
                                        <label for="v-1706330978554-paymentMethod" class="mb-2">Default Payment Method<span class="text-danger">*</span></label>
                                        <select
                                            id="v-1706330978554-paymentMethod"
                                            data-qa="payment-method-dropdown"
                                            class="form-control custom-select mb-6"
                                            style="max-width: 280px;"
                                            wire:model="payment_method">
                                            <option class="text-capitalize" value=""> Select </option>
                                            <option class="text-capitalize" value="moneybased"> Money-based </option>
