                                    ...
                                    <div data-v-07ab28b9="" class="mx-1 d-md-none">
                                        <div data-v-07ab28b9="" class="d-flex ml-minus-3">
                                            <div data-v-07ab28b9="" class="ml-3">
                                                <button data-v-07ab28b9="" class="btn btn-default p-2">
                                                    <div data-v-07ab28b9=""
                                                        class="icon-slot icon-slot-18 line-height-18">
                                                        <div data-v-07ab28b9="" class="p-abs centered font-size-18">
                                                            <svg data-v-07ab28b9="" svg-inline="" focusable="false"
                                                                role="presentation" xmlns="http://www.w3.org/2000/svg"
                                                                width="24" height="24" viewBox="0 0 24 24"
                                                                fill="none" stroke="currentColor" stroke-width="1.4"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="icon-stroke">
                                                                <polygon data-v-07ab28b9=""
                                            ...
                                            <div data-v-07ab28b9="" class="ml-3">
                                                <span data-v-07ab28b9="">
                                                    <span class="" style="display:none">
                                                        <div data-v-07ab28b9="" tabindex="0"
                                                            class="z-index-popover bg-white border-radius-base border border-gray-40 py-1 mt-1 focus-outline"
                                                    ...
                                                    <div data-v-07ab28b9="" class="btn btn-default d-block p-2">
                                                        <div data-v-07ab28b9=""
                                                            class="icon-slot icon-slot-18 line-height-18">
                                                            <div data-v-07ab28b9="" class="p-abs centered font-size-18">
                                                                <svg data-v-07ab28b9="" svg-inline="" focusable="false"
                                                            ...
                                                            <div class="d-md-inline-flex ml-5">
                                                                <div class="min-w-0">
                                                                    <div class="align-items-center line-height-20">
                                                                        <div
                                                                            @class(
                                                                                ['select-btn-new form-control', 'open' => $campaignOpen]
                                                                            )
                                                                            wire:click="openCampaign"
                                                                            style="width: 170px !important;">
                        ...
                        <div>
                            <div class="panel mb-0">
                                <div class="mb-0 p-rel table-responsive-xl">
                                    ...
                                    <hr class="my-0">
                                    {{ $donationData->links('custom-pagination') }}
                                </div>
                            </div>
                        </div>
                    </div>
