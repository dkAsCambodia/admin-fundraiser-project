                            ...
                            <div class="d-md-block d-none">
                                ...
                                <div class="bg-gray-10 border-bottom-radius-base">
                                    <div data-v-bba3536e="">
                                        <div data-v-bba3536e="" class="px-6 px-xl-8 py-2 py-md-4">
                                            <div data-v-bba3536e="" class="d-table table-layout-fixed w-100">
                                                <div data-v-bba3536e="" class="d-table-cell">
                                                    ...
                                                    <div data-v-bba3536e="" data-title="Filter Campaigns">
                                                        <div data-v-bba3536e=""
                                                            ...
                                                            <div data-v-bba3536e=""
                                                                ...
                                                                <div class="p-rel mx-md-4">
                                                                    <input type="text" dir="auto"
                                                                        ...
                                                                        placeholder="Campaign name" autocomplete="off"
                                                                ...
                                                                <div class="d-md-inline-flex">
                                                                    <div class="min-w-0">
                                                                        <div class="align-items-center line-height-20">
                                                                            <div
                                                                                @class(
                                                                                    ['select-btn-new form-control', 'open' => $accountOpen]
                                                                                )
                                                            ...
                                                            {{-- <div data-v-bba3536e=""
                                                                    ...
                                                                    <div data-v-2d9819c6="" class="min-w-0"
                                                                        data-v-bba3536e="" data-st-filter="paymentOption">
                                        ...
                                        <div data-v-bba3536e="" id="more-filters" class="d-block d-md-none">
                                            <hr data-v-bba3536e="" class="m-0 d-none d-md-block">
                                            <div data-v-bba3536e="" class="c-more-filters"></div>
                                        </div>
                                        <div data-v-bba3536e="" class="d-md-none">
                                            <hr data-v-bba3536e="" class="my-0">
                                            <div data-v-bba3536e=""
                                                class="px-6 py-3 font-size-14 line-height-20 bg-gray-25 border-bottom-radius-base">
                                                <div data-v-bba3536e=""
                                                    class="d-flex justify-content-between mx-minus-1">
                                                    <div data-v-bba3536e="" class="min-w-0 mx-1">
                                                        <div data-v-bba3536e="" tabindex="0"
                                                            class="d-flex cursor-pointer focus-outline">
                                                            <div data-v-bba3536e="" class="mr-2">
                                                                <div data-v-bba3536e=""
                                                                    class="icon-slot icon-slot-18">
                                                                    <div data-v-bba3536e=""
                                                                        class="p-abs centered font-size-18">
                                                                        <svg data-v-bba3536e="" svg-inline=""
                                                                            ...
                                                                            stroke-linejoin="round"
                                                                            class="icon-stroke">
                                                                            <path data-v-bba3536e=""
                                                                                d="M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19m-6.72-1.07a3 3 0 11-4.24-4.24">
                                                                            </path>
                                                                            <line data-v-bba3536e="" x1="1"
                                                                                y1="1" x2="23"
                                                                                y2="23"></line>
                                                                        </svg>
                                                                    </div>
                                                            ...
                                                            <div data-v-bba3536e="" class="min-w-0 text-truncate">Hide
                                                                filters</div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div>
                            <div class="panel mb-0">
                                <div class="mb-0 p-rel table-responsive-xl">
                                            ...
                                            <div data-v-42ed51cc=""
                                                ...
                                                @forelse ($campaigns as $camp)
                                                    <div wire:click=""
                                                        ...
                                                        <div class="d-td">
                                                            <div title="" class="text-truncate max-w-px-200">
                                                                <img src="{{ asset('storage/' . $camp->photo) }}"
                                                                    height="40" width="100" />
                                                            </div>
                                                        </div>
                                                        <div class="d-td">
                                                        ...
                                                        <div class="d-td">
                                                            <div title="" class="text-truncate max-w-px-200">
                                                                <a href="/campaigns/{{ $camp->id }}/create"
                                                                    wire:navigate>
                                                                    Edit
                                                                </a>
                                                            </div>
                                    ...
                                    <hr class="my-0">
                                    {{ $campaigns->links('custom-pagination') }}
                                </div>
                            </div>
                        </div>
                    </div>
